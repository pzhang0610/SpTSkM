...
if __name__ == "__main__":
    ...
    # train_name = './no_norm/train_data.npy'
    # train_label = './no_norm/train_label.pkl'
    ...
    gallery_name = './no_norm/gallery_data.npy'
    gallery_label = './no_norm/gallery_label.pkl'
    testset.index_test(gallery_name, gallery_label,gallery_num=4, is_gallery=True)

    probe_name = './no_norm/probe_data.npy'
    probe_label = './no_norm/probe_label.pkl'
    testset.index_test(probe_name, probe_label, gallery_num=4, is_gallery=False)